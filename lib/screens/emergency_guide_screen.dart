...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        scaffoldBackgroundColor: const Color(0xFFF8F9FA), // Soft light background
        useMaterial3: true,
      ),
      home: const EmergencyGuideScreen(),
    );
  }
}
...
class EmergencyGuideScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Data list representing each guide item
    final List<GuideItem> items = [
      ...
      GuideItem(
        ...
        icon: Icons.gavel, // Placeholder for tectonic/earthquake icon
  ...
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (context) => const GuideDetailsScreen(),
    ),
  );
},
            ),
...
// Data Model to neatly manage the state
class GuideItem {
  final String title;
