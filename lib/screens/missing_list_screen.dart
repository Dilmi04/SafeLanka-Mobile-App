...
class MissingPersonsListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Dynamic mock list structured using data from the image layout sample
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.tune, color: Colors.black, size: 22), // Filter icon matching configuration
            onPressed: () {},
          ),
        ],
      ),
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  // 1. Profile Photo Container with explicit curved clipping properties
                  Container(
                    width: 76,
                    height: 86,
                    decoration: BoxDecoration(
                  ...
                  // 2. Data details text stack block
                  Expanded(
                    child: Column(
...
fontWeight: FontWeight.w500,                          ),
                  ...
                  // 3. Arrow trailing navigation indicator icon
                  Icon(
...
// Data object model blueprint mapping
class MissingPerson {
  final String name;
  final int age;
